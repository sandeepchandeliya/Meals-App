// Make a favourites meal array if it's not exist in local storage
...
// Show all meals card in the main section according to the search input value
...
// Show all favourite meals in the favourites body
...
// Add and remove meals from the favourites list
function addRemoveToFavList(id) {
    let arr = JSON.parse(localStorage.getItem("favouritesList"));
    let isFav = arr.includes(id);
